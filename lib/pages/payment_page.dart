...
body: Container(
  ...
  child: Column(
    children: [
              ...
              return Container(
                child: Column(
                  children: [
                    ...
                    Divider(thickness: 2,color: Colors.grey.withOpacity(0.6),),
      ...
      //Call the Reuseable Button[button.dart]
      Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          AppButtons(icon: Icons.share_sharp,onTap: (){},text: "share",),
          SizedBox(width: 80,),
          AppButtons(icon: Icons.local_print_shop_outlined,onTap: (){},text: "print",)
